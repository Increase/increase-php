...
namespace Increase\Cards\CardCreateParams\AuthorizationControls\MerchantAcceptorIdentifier;
...
/**
 * @phpstan-type BlockedShape = array{identifier: string}
 */
final class Blocked implements BaseModel
{
     ...
     * ```
     * Blocked::with(identifier: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new Blocked)->withIdentifier(...)
     * ```
     */
