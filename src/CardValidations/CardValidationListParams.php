 ...
 *
 * @see Increase\Services\CardValidationsService::list()
 *
 ...
 *
 * @phpstan-type CardValidationListParamsShape = array{
 ...
 * }
 */
final class CardValidationListParams implements BaseModel
{
    /** @use SdkModel<CardValidationListParamsShape> */
    use SdkModel;
    use SdkParams;
