...
namespace Increase\Entities\EntityUpdateParams\SoleProprietorship\SoleProprietor;

use Increase\Core\Attributes\Optional;
use Increase\Core\Attributes\Required;
use Increase\Core\Concerns\SdkModel;
use Increase\Core\Contracts\BaseModel;
use Increase\Entities\EntityUpdateParams\SoleProprietorship\SoleProprietor\Identification\DriversLicense;
use Increase\Entities\EntityUpdateParams\SoleProprietorship\SoleProprietor\Identification\Method;
use Increase\Entities\EntityUpdateParams\SoleProprietorship\SoleProprietor\Identification\Other;
use Increase\Entities\EntityUpdateParams\SoleProprietorship\SoleProprietor\Identification\Passport;

/**
 * A means of verifying the sole proprietor's identity. Unlike at creation, an identity document is accepted here.
 *
 * @phpstan-import-type DriversLicenseShape from \Increase\Entities\EntityUpdateParams\SoleProprietorship\SoleProprietor\Identification\DriversLicense
 * @phpstan-import-type OtherShape from \Increase\Entities\EntityUpdateParams\SoleProprietorship\SoleProprietor\Identification\Other
 * @phpstan-import-type PassportShape from \Increase\Entities\EntityUpdateParams\SoleProprietorship\SoleProprietor\Identification\Passport
 *
