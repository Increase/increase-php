...
use Increase\CardDisputes\CardDisputeSubmitUserSubmissionParams\Visa\Chargeback\Authorization;
use Increase\CardDisputes\CardDisputeSubmitUserSubmissionParams\Visa\Chargeback\Category;
use Increase\CardDisputes\CardDisputeSubmitUserSubmissionParams\Visa\Chargeback\ConsumerCanceledMerchandise;
use Increase\CardDisputes\CardDisputeSubmitUserSubmissionParams\Visa\Chargeback\ConsumerCanceledRecurringTransaction;
use Increase\CardDisputes\CardDisputeSubmitUserSubmissionParams\Visa\Chargeback\ConsumerCanceledServices;
use Increase\CardDisputes\CardDisputeSubmitUserSubmissionParams\Visa\Chargeback\ConsumerCounterfeitMerchandise;
use Increase\CardDisputes\CardDisputeSubmitUserSubmissionParams\Visa\Chargeback\ConsumerCreditNotProcessed;
use Increase\CardDisputes\CardDisputeSubmitUserSubmissionParams\Visa\Chargeback\ConsumerDamagedOrDefectiveMerchandise;
use Increase\CardDisputes\CardDisputeSubmitUserSubmissionParams\Visa\Chargeback\ConsumerMerchandiseMisrepresentation;
use Increase\CardDisputes\CardDisputeSubmitUserSubmissionParams\Visa\Chargeback\ConsumerMerchandiseNotAsDescribed;
use Increase\CardDisputes\CardDisputeSubmitUserSubmissionParams\Visa\Chargeback\ConsumerMerchandiseNotReceived;
use Increase\CardDisputes\CardDisputeSubmitUserSubmissionParams\Visa\Chargeback\ConsumerNonReceiptOfCash;
use Increase\CardDisputes\CardDisputeSubmitUserSubmissionParams\Visa\Chargeback\ConsumerOriginalCreditTransactionNotAccepted;
use Increase\CardDisputes\CardDisputeSubmitUserSubmissionParams\Visa\Chargeback\ConsumerQualityMerchandise;
use Increase\CardDisputes\CardDisputeSubmitUserSubmissionParams\Visa\Chargeback\ConsumerQualityServices;
use Increase\CardDisputes\CardDisputeSubmitUserSubmissionParams\Visa\Chargeback\ConsumerServicesMisrepresentation;
use Increase\CardDisputes\CardDisputeSubmitUserSubmissionParams\Visa\Chargeback\ConsumerServicesNotAsDescribed;
use Increase\CardDisputes\CardDisputeSubmitUserSubmissionParams\Visa\Chargeback\ConsumerServicesNotReceived;
use Increase\CardDisputes\CardDisputeSubmitUserSubmissionParams\Visa\Chargeback\Fraud;
use Increase\CardDisputes\CardDisputeSubmitUserSubmissionParams\Visa\Chargeback\ProcessingError;
 ...
 *
 * @phpstan-import-type AuthorizationShape from \Increase\CardDisputes\CardDisputeSubmitUserSubmissionParams\Visa\Chargeback\Authorization
 * @phpstan-import-type ConsumerCanceledMerchandiseShape from \Increase\CardDisputes\CardDisputeSubmitUserSubmissionParams\Visa\Chargeback\ConsumerCanceledMerchandise
 * @phpstan-import-type ConsumerCanceledRecurringTransactionShape from \Increase\CardDisputes\CardDisputeSubmitUserSubmissionParams\Visa\Chargeback\ConsumerCanceledRecurringTransaction
 * @phpstan-import-type ConsumerCanceledServicesShape from \Increase\CardDisputes\CardDisputeSubmitUserSubmissionParams\Visa\Chargeback\ConsumerCanceledServices
 * @phpstan-import-type ConsumerCounterfeitMerchandiseShape from \Increase\CardDisputes\CardDisputeSubmitUserSubmissionParams\Visa\Chargeback\ConsumerCounterfeitMerchandise
 * @phpstan-import-type ConsumerCreditNotProcessedShape from \Increase\CardDisputes\CardDisputeSubmitUserSubmissionParams\Visa\Chargeback\ConsumerCreditNotProcessed
 * @phpstan-import-type ConsumerDamagedOrDefectiveMerchandiseShape from \Increase\CardDisputes\CardDisputeSubmitUserSubmissionParams\Visa\Chargeback\ConsumerDamagedOrDefectiveMerchandise
 * @phpstan-import-type ConsumerMerchandiseMisrepresentationShape from \Increase\CardDisputes\CardDisputeSubmitUserSubmissionParams\Visa\Chargeback\ConsumerMerchandiseMisrepresentation
 * @phpstan-import-type ConsumerMerchandiseNotAsDescribedShape from \Increase\CardDisputes\CardDisputeSubmitUserSubmissionParams\Visa\Chargeback\ConsumerMerchandiseNotAsDescribed
 * @phpstan-import-type ConsumerMerchandiseNotReceivedShape from \Increase\CardDisputes\CardDisputeSubmitUserSubmissionParams\Visa\Chargeback\ConsumerMerchandiseNotReceived
 * @phpstan-import-type ConsumerNonReceiptOfCashShape from \Increase\CardDisputes\CardDisputeSubmitUserSubmissionParams\Visa\Chargeback\ConsumerNonReceiptOfCash
 * @phpstan-import-type ConsumerOriginalCreditTransactionNotAcceptedShape from \Increase\CardDisputes\CardDisputeSubmitUserSubmissionParams\Visa\Chargeback\ConsumerOriginalCreditTransactionNotAccepted
 * @phpstan-import-type ConsumerQualityMerchandiseShape from \Increase\CardDisputes\CardDisputeSubmitUserSubmissionParams\Visa\Chargeback\ConsumerQualityMerchandise
 * @phpstan-import-type ConsumerQualityServicesShape from \Increase\CardDisputes\CardDisputeSubmitUserSubmissionParams\Visa\Chargeback\ConsumerQualityServices
 * @phpstan-import-type ConsumerServicesMisrepresentationShape from \Increase\CardDisputes\CardDisputeSubmitUserSubmissionParams\Visa\Chargeback\ConsumerServicesMisrepresentation
 * @phpstan-import-type ConsumerServicesNotAsDescribedShape from \Increase\CardDisputes\CardDisputeSubmitUserSubmissionParams\Visa\Chargeback\ConsumerServicesNotAsDescribed
 * @phpstan-import-type ConsumerServicesNotReceivedShape from \Increase\CardDisputes\CardDisputeSubmitUserSubmissionParams\Visa\Chargeback\ConsumerServicesNotReceived
 * @phpstan-import-type FraudShape from \Increase\CardDisputes\CardDisputeSubmitUserSubmissionParams\Visa\Chargeback\Fraud
 * @phpstan-import-type ProcessingErrorShape from \Increase\CardDisputes\CardDisputeSubmitUserSubmissionParams\Visa\Chargeback\ProcessingError
 *
 * @phpstan-type ChargebackShape = array{
 *   category: \Increase\CardDisputes\CardDisputeSubmitUserSubmissionParams\Visa\Chargeback\Category|value-of<\Increase\CardDisputes\CardDisputeSubmitUserSubmissionParams\Visa\Chargeback\Category>,
...
final class Chargeback implements BaseModel
{
     ...
     * ```
     * Chargeback::with(category: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new Chargeback)->withCategory(...)
     * ```
     */
