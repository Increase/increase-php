 ...
 *
 * @see Increase\Services\CardPushTransfersService::list()
 *
 ...
 *
 * @phpstan-type CardPushTransferListParamsShape = array{
 ...
 * }
 */
final class CardPushTransferListParams implements BaseModel
{
    /** @use SdkModel<CardPushTransferListParamsShape> */
    use SdkModel;
    use SdkParams;
