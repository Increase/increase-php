...
namespace Increase\AccountStatements\AccountStatementListParams;
...
/**
 * @phpstan-type StatementPeriodStartShape = array{
 ...
 * }
 */
final class StatementPeriodStart implements BaseModel
{
    /** @use SdkModel<StatementPeriodStartShape> */
    use SdkModel;
