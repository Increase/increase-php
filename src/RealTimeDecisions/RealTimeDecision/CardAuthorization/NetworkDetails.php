...
use Increase\RealTimeDecisions\RealTimeDecision\CardAuthorization\NetworkDetails\Category;
use Increase\RealTimeDecisions\RealTimeDecision\CardAuthorization\NetworkDetails\Pulse;
use Increase\RealTimeDecisions\RealTimeDecision\CardAuthorization\NetworkDetails\Visa;

/**
 * Fields specific to the `network`.
 *
 * @phpstan-import-type PulseShape from \Increase\RealTimeDecisions\RealTimeDecision\CardAuthorization\NetworkDetails\Pulse
 * @phpstan-import-type VisaShape from \Increase\RealTimeDecisions\RealTimeDecision\CardAuthorization\NetworkDetails\Visa
 *
