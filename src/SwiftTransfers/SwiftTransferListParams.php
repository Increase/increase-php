 ...
 *
 * @see Increase\Services\SwiftTransfersService::list()
 *
 ...
 *
 * @phpstan-type SwiftTransferListParamsShape = array{
 ...
 * }
 */
final class SwiftTransferListParams implements BaseModel
{
    /** @use SdkModel<SwiftTransferListParamsShape> */
    use SdkModel;
    use SdkParams;
