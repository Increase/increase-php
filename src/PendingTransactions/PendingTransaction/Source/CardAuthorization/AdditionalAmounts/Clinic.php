 ...
 *
 * @phpstan-type ClinicShape = array{amount: int, currency: string}
 */
final class Clinic implements BaseModel
{
    /** @use SdkModel<ClinicShape> */
    use SdkModel;
    ...
    /**
     * `new Clinic()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * Clinic::with(amount: ..., currency: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new Clinic)->withAmount(...)->withCurrency(...)
     * ```
     */
