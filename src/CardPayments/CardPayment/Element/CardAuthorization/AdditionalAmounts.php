...
use Increase\CardPayments\CardPayment\Element\CardAuthorization\AdditionalAmounts\Clinic;
use Increase\CardPayments\CardPayment\Element\CardAuthorization\AdditionalAmounts\Dental;
use Increase\CardPayments\CardPayment\Element\CardAuthorization\AdditionalAmounts\Original;
use Increase\CardPayments\CardPayment\Element\CardAuthorization\AdditionalAmounts\Prescription;
use Increase\CardPayments\CardPayment\Element\CardAuthorization\AdditionalAmounts\Surcharge;
use Increase\CardPayments\CardPayment\Element\CardAuthorization\AdditionalAmounts\TotalCumulative;
use Increase\CardPayments\CardPayment\Element\CardAuthorization\AdditionalAmounts\TotalHealthcare;
use Increase\CardPayments\CardPayment\Element\CardAuthorization\AdditionalAmounts\Transit;
use Increase\CardPayments\CardPayment\Element\CardAuthorization\AdditionalAmounts\Unknown;
use Increase\CardPayments\CardPayment\Element\CardAuthorization\AdditionalAmounts\Vision;
 ...
 * @phpstan-import-type OriginalShape from \Increase\CardPayments\CardPayment\Element\CardAuthorization\AdditionalAmounts\Original
 * @phpstan-import-type PrescriptionShape from \Increase\CardPayments\CardPayment\Element\CardAuthorization\AdditionalAmounts\Prescription
 * @phpstan-import-type SurchargeShape from \Increase\CardPayments\CardPayment\Element\CardAuthorization\AdditionalAmounts\Surcharge
 * @phpstan-import-type TotalCumulativeShape from \Increase\CardPayments\CardPayment\Element\CardAuthorization\AdditionalAmounts\TotalCumulative
 * @phpstan-import-type TotalHealthcareShape from \Increase\CardPayments\CardPayment\Element\CardAuthorization\AdditionalAmounts\TotalHealthcare
 * @phpstan-import-type TransitShape from \Increase\CardPayments\CardPayment\Element\CardAuthorization\AdditionalAmounts\Transit
 * @phpstan-import-type UnknownShape from \Increase\CardPayments\CardPayment\Element\CardAuthorization\AdditionalAmounts\Unknown
 * @phpstan-import-type VisionShape from \Increase\CardPayments\CardPayment\Element\CardAuthorization\AdditionalAmounts\Vision
 *
