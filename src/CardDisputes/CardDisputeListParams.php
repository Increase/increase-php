 ...
 * List Card Disputes.
 *
 * @see Increase\Services\CardDisputesService::list()
 *
 ...
 *
 * @phpstan-type CardDisputeListParamsShape = array{
 ...
 * }
 */
final class CardDisputeListParams implements BaseModel
{
    /** @use SdkModel<CardDisputeListParamsShape> */
    use SdkModel;
    use SdkParams;
