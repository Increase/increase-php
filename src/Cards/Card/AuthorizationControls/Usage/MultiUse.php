...
use Increase\Cards\Card\AuthorizationControls\Usage\MultiUse\SpendingLimit;
 ...
 *
 * @phpstan-import-type SpendingLimitShape from \Increase\Cards\Card\AuthorizationControls\Usage\MultiUse\SpendingLimit
 *
...
final class MultiUse implements BaseModel
{
    ...
    /**
     * `new MultiUse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * MultiUse::with(spendingLimits: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new MultiUse)->withSpendingLimits(...)
     * ```
     */
     ...
     */
    public static function with(?array $spendingLimits): self
    {
        $self = new self;
