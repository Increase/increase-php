 ...
 *
 * @phpstan-type VisionShape = array{amount: int, currency: string}
 */
final class Vision implements BaseModel
{
    /** @use SdkModel<VisionShape> */
    use SdkModel;
    ...
    /**
     * `new Vision()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * Vision::with(amount: ..., currency: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new Vision)->withAmount(...)->withCurrency(...)
     * ```
     */
