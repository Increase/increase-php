...
use Increase\CardPayments\CardPayment\Element\CardValidation\AdditionalAmounts\Clinic;
use Increase\CardPayments\CardPayment\Element\CardValidation\AdditionalAmounts\Dental;
use Increase\CardPayments\CardPayment\Element\CardValidation\AdditionalAmounts\Original;
use Increase\CardPayments\CardPayment\Element\CardValidation\AdditionalAmounts\Prescription;
use Increase\CardPayments\CardPayment\Element\CardValidation\AdditionalAmounts\Surcharge;
use Increase\CardPayments\CardPayment\Element\CardValidation\AdditionalAmounts\TotalCumulative;
use Increase\CardPayments\CardPayment\Element\CardValidation\AdditionalAmounts\TotalHealthcare;
use Increase\CardPayments\CardPayment\Element\CardValidation\AdditionalAmounts\Transit;
use Increase\CardPayments\CardPayment\Element\CardValidation\AdditionalAmounts\Unknown;
use Increase\CardPayments\CardPayment\Element\CardValidation\AdditionalAmounts\Vision;
 ...
 *
 * @phpstan-import-type ClinicShape from \Increase\CardPayments\CardPayment\Element\CardValidation\AdditionalAmounts\Clinic
 * @phpstan-import-type DentalShape from \Increase\CardPayments\CardPayment\Element\CardValidation\AdditionalAmounts\Dental
 * @phpstan-import-type OriginalShape from \Increase\CardPayments\CardPayment\Element\CardValidation\AdditionalAmounts\Original
 * @phpstan-import-type PrescriptionShape from \Increase\CardPayments\CardPayment\Element\CardValidation\AdditionalAmounts\Prescription
 * @phpstan-import-type SurchargeShape from \Increase\CardPayments\CardPayment\Element\CardValidation\AdditionalAmounts\Surcharge
 * @phpstan-import-type TotalCumulativeShape from \Increase\CardPayments\CardPayment\Element\CardValidation\AdditionalAmounts\TotalCumulative
 * @phpstan-import-type TotalHealthcareShape from \Increase\CardPayments\CardPayment\Element\CardValidation\AdditionalAmounts\TotalHealthcare
 * @phpstan-import-type TransitShape from \Increase\CardPayments\CardPayment\Element\CardValidation\AdditionalAmounts\Transit
 * @phpstan-import-type UnknownShape from \Increase\CardPayments\CardPayment\Element\CardValidation\AdditionalAmounts\Unknown
 * @phpstan-import-type VisionShape from \Increase\CardPayments\CardPayment\Element\CardValidation\AdditionalAmounts\Vision
 *
