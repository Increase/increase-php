 ...
 *
 * @see Increase\Services\PhysicalCardProfilesService::list()
 *
 * @phpstan-import-type StatusShape from \Increase\PhysicalCardProfiles\PhysicalCardProfileListParams\Status
 *
 * @phpstan-type PhysicalCardProfileListParamsShape = array{
 *   cursor?: string|null,
 ...
 * }
 */
final class PhysicalCardProfileListParams implements BaseModel
{
    /** @use SdkModel<PhysicalCardProfileListParamsShape> */
    use SdkModel;
    use SdkParams;
