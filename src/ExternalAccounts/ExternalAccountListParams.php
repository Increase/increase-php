 ...
 *
 * @see Increase\Services\ExternalAccountsService::list()
 *
 * @phpstan-import-type StatusShape from \Increase\ExternalAccounts\ExternalAccountListParams\Status
 *
 * @phpstan-type ExternalAccountListParamsShape = array{
 *   cursor?: string|null,
 ...
 * }
 */
final class ExternalAccountListParams implements BaseModel
{
    /** @use SdkModel<ExternalAccountListParamsShape> */
    use SdkModel;
    use SdkParams;
