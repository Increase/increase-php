 ...
 *
 * @phpstan-type UnknownShape = array{amount: int, currency: string}
 */
final class Unknown implements BaseModel
{
    /** @use SdkModel<UnknownShape> */
    use SdkModel;
    ...
    /**
     * `new Unknown()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * Unknown::with(amount: ..., currency: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new Unknown)->withAmount(...)->withCurrency(...)
     * ```
     */
