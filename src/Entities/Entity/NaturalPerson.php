...
use Increase\Entities\Entity\NaturalPerson\Address;
use Increase\Entities\Entity\NaturalPerson\Identification;

/**
 * Details of the natural person entity. Will be present if `structure` is equal to `natural_person`.
 *
 * @phpstan-import-type AddressShape from \Increase\Entities\Entity\NaturalPerson\Address
 * @phpstan-import-type IdentificationShape from \Increase\Entities\Entity\NaturalPerson\Identification
 *
