...
use Increase\ServiceContracts\Simulations\CardBalanceInquiriesContract;
 ...
 */
final class CardBalanceInquiriesService implements CardBalanceInquiriesContract
{
    /**
     * @api
     */
    public CardBalanceInquiriesRawService $raw;
    ...
    {
        $this->raw = new CardBalanceInquiriesRawService($client);
    }
