...
namespace Increase\Entities\EntityCreateBeneficialOwnerParams\BeneficialOwner\Individual;

use Increase\Core\Attributes\Optional;
use Increase\Core\Attributes\Required;
use Increase\Core\Concerns\SdkModel;
use Increase\Core\Contracts\BaseModel;
use Increase\Entities\EntityCreateBeneficialOwnerParams\BeneficialOwner\Individual\Identification\DriversLicense;
use Increase\Entities\EntityCreateBeneficialOwnerParams\BeneficialOwner\Individual\Identification\Method;
use Increase\Entities\EntityCreateBeneficialOwnerParams\BeneficialOwner\Individual\Identification\Other;
use Increase\Entities\EntityCreateBeneficialOwnerParams\BeneficialOwner\Individual\Identification\Passport;

/**
 * A means of verifying the person's identity.
 *
 * @phpstan-import-type DriversLicenseShape from \Increase\Entities\EntityCreateBeneficialOwnerParams\BeneficialOwner\Individual\Identification\DriversLicense
 * @phpstan-import-type OtherShape from \Increase\Entities\EntityCreateBeneficialOwnerParams\BeneficialOwner\Individual\Identification\Other
 * @phpstan-import-type PassportShape from \Increase\Entities\EntityCreateBeneficialOwnerParams\BeneficialOwner\Individual\Identification\Passport
 *
