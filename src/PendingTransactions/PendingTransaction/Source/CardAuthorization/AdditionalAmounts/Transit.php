 ...
 *
 * @phpstan-type TransitShape = array{amount: int, currency: string}
 */
final class Transit implements BaseModel
{
    /** @use SdkModel<TransitShape> */
    use SdkModel;
    ...
    /**
     * `new Transit()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * Transit::with(amount: ..., currency: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new Transit)->withAmount(...)->withCurrency(...)
     * ```
     */
