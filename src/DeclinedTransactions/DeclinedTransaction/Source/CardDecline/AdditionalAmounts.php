...
use Increase\DeclinedTransactions\DeclinedTransaction\Source\CardDecline\AdditionalAmounts\Clinic;
use Increase\DeclinedTransactions\DeclinedTransaction\Source\CardDecline\AdditionalAmounts\Dental;
use Increase\DeclinedTransactions\DeclinedTransaction\Source\CardDecline\AdditionalAmounts\Original;
use Increase\DeclinedTransactions\DeclinedTransaction\Source\CardDecline\AdditionalAmounts\Prescription;
use Increase\DeclinedTransactions\DeclinedTransaction\Source\CardDecline\AdditionalAmounts\Surcharge;
use Increase\DeclinedTransactions\DeclinedTransaction\Source\CardDecline\AdditionalAmounts\TotalCumulative;
use Increase\DeclinedTransactions\DeclinedTransaction\Source\CardDecline\AdditionalAmounts\TotalHealthcare;
use Increase\DeclinedTransactions\DeclinedTransaction\Source\CardDecline\AdditionalAmounts\Transit;
use Increase\DeclinedTransactions\DeclinedTransaction\Source\CardDecline\AdditionalAmounts\Unknown;
use Increase\DeclinedTransactions\DeclinedTransaction\Source\CardDecline\AdditionalAmounts\Vision;
 ...
 *
 * @phpstan-import-type ClinicShape from \Increase\DeclinedTransactions\DeclinedTransaction\Source\CardDecline\AdditionalAmounts\Clinic
 * @phpstan-import-type DentalShape from \Increase\DeclinedTransactions\DeclinedTransaction\Source\CardDecline\AdditionalAmounts\Dental
 * @phpstan-import-type OriginalShape from \Increase\DeclinedTransactions\DeclinedTransaction\Source\CardDecline\AdditionalAmounts\Original
 * @phpstan-import-type PrescriptionShape from \Increase\DeclinedTransactions\DeclinedTransaction\Source\CardDecline\AdditionalAmounts\Prescription
 * @phpstan-import-type SurchargeShape from \Increase\DeclinedTransactions\DeclinedTransaction\Source\CardDecline\AdditionalAmounts\Surcharge
 * @phpstan-import-type TotalCumulativeShape from \Increase\DeclinedTransactions\DeclinedTransaction\Source\CardDecline\AdditionalAmounts\TotalCumulative
 * @phpstan-import-type TotalHealthcareShape from \Increase\DeclinedTransactions\DeclinedTransaction\Source\CardDecline\AdditionalAmounts\TotalHealthcare
 * @phpstan-import-type TransitShape from \Increase\DeclinedTransactions\DeclinedTransaction\Source\CardDecline\AdditionalAmounts\Transit
 * @phpstan-import-type UnknownShape from \Increase\DeclinedTransactions\DeclinedTransaction\Source\CardDecline\AdditionalAmounts\Unknown
 * @phpstan-import-type VisionShape from \Increase\DeclinedTransactions\DeclinedTransaction\Source\CardDecline\AdditionalAmounts\Vision
 *
