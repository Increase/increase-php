 ...
 * List ACH Transfers.
 *
 * @see Increase\Services\ACHTransfersService::list()
 *
 ...
 *
 * @phpstan-type ACHTransferListParamsShape = array{
 ...
 * }
 */
final class ACHTransferListParams implements BaseModel
{
    /** @use SdkModel<ACHTransferListParamsShape> */
    use SdkModel;
    use SdkParams;
