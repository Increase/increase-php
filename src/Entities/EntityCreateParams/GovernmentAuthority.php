...
use Increase\Entities\EntityCreateParams\GovernmentAuthority\Address;
use Increase\Entities\EntityCreateParams\GovernmentAuthority\AuthorizedPerson;
use Increase\Entities\EntityCreateParams\GovernmentAuthority\Category;

/**
 * Details of the Government Authority entity to create. Required if `structure` is equal to `government_authority`.
 *
 * @phpstan-import-type AddressShape from \Increase\Entities\EntityCreateParams\GovernmentAuthority\Address
 * @phpstan-import-type AuthorizedPersonShape from \Increase\Entities\EntityCreateParams\GovernmentAuthority\AuthorizedPerson
 *
