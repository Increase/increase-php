...
namespace Increase\Entities\EntityCreateParams\Trust\Trustee;

use Increase\Core\Attributes\Optional;
use Increase\Core\Attributes\Required;
use Increase\Core\Concerns\SdkModel;
use Increase\Core\Contracts\BaseModel;
use Increase\Entities\EntityCreateParams\Trust\Trustee\Individual\Address;
use Increase\Entities\EntityCreateParams\Trust\Trustee\Individual\Identification;

/**
 * Details of the individual trustee. Within the trustee object, this is required if `structure` is equal to `individual`.
 *
 * @phpstan-import-type AddressShape from \Increase\Entities\EntityCreateParams\Trust\Trustee\Individual\Address
 * @phpstan-import-type IdentificationShape from \Increase\Entities\EntityCreateParams\Trust\Trustee\Individual\Identification
 *
