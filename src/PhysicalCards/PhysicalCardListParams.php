 ...
 * }
 */
final class PhysicalCardListParams implements BaseModel
{
    /** @use SdkModel<PhysicalCardListParamsShape> */
    use SdkModel;
    use SdkParams;
