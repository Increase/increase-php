 ...
 *
 * @phpstan-type EntityOnboardingSessionListParamsShape = array{
 *   cursor?: string|null,
 ...
 * }
 */
final class EntityOnboardingSessionListParams implements BaseModel
{
    /** @use SdkModel<EntityOnboardingSessionListParamsShape> */
    use SdkModel;
    use SdkParams;
