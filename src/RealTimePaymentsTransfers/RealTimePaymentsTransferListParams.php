 ...
 *
 * @see Increase\Services\RealTimePaymentsTransfersService::list()
 *
 ...
 *
 * @phpstan-type RealTimePaymentsTransferListParamsShape = array{
 ...
 * }
 */
final class RealTimePaymentsTransferListParams implements BaseModel
{
    /** @use SdkModel<RealTimePaymentsTransferListParamsShape> */
    use SdkModel;
    use SdkParams;
