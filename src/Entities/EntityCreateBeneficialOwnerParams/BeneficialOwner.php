...
namespace Increase\Entities\EntityCreateBeneficialOwnerParams;

use Increase\Core\Attributes\Optional;
use Increase\Core\Attributes\Required;
use Increase\Core\Concerns\SdkModel;
use Increase\Core\Contracts\BaseModel;
use Increase\Entities\EntityCreateBeneficialOwnerParams\BeneficialOwner\Individual;
use Increase\Entities\EntityCreateBeneficialOwnerParams\BeneficialOwner\Prong;

/**
 * The identifying details of anyone controlling or owning 25% or more of the corporation.
 *
 * @phpstan-import-type IndividualShape from \Increase\Entities\EntityCreateBeneficialOwnerParams\BeneficialOwner\Individual
 *
