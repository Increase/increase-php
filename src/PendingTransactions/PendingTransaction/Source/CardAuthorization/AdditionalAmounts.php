...
use Increase\PendingTransactions\PendingTransaction\Source\CardAuthorization\AdditionalAmounts\Clinic;
use Increase\PendingTransactions\PendingTransaction\Source\CardAuthorization\AdditionalAmounts\Dental;
use Increase\PendingTransactions\PendingTransaction\Source\CardAuthorization\AdditionalAmounts\Original;
use Increase\PendingTransactions\PendingTransaction\Source\CardAuthorization\AdditionalAmounts\Prescription;
use Increase\PendingTransactions\PendingTransaction\Source\CardAuthorization\AdditionalAmounts\Surcharge;
use Increase\PendingTransactions\PendingTransaction\Source\CardAuthorization\AdditionalAmounts\TotalCumulative;
use Increase\PendingTransactions\PendingTransaction\Source\CardAuthorization\AdditionalAmounts\TotalHealthcare;
use Increase\PendingTransactions\PendingTransaction\Source\CardAuthorization\AdditionalAmounts\Transit;
use Increase\PendingTransactions\PendingTransaction\Source\CardAuthorization\AdditionalAmounts\Unknown;
 ...
 * @phpstan-import-type OriginalShape from \Increase\PendingTransactions\PendingTransaction\Source\CardAuthorization\AdditionalAmounts\Original
 * @phpstan-import-type PrescriptionShape from \Increase\PendingTransactions\PendingTransaction\Source\CardAuthorization\AdditionalAmounts\Prescription
 * @phpstan-import-type SurchargeShape from \Increase\PendingTransactions\PendingTransaction\Source\CardAuthorization\AdditionalAmounts\Surcharge
 * @phpstan-import-type TotalCumulativeShape from \Increase\PendingTransactions\PendingTransaction\Source\CardAuthorization\AdditionalAmounts\TotalCumulative
 * @phpstan-import-type TotalHealthcareShape from \Increase\PendingTransactions\PendingTransaction\Source\CardAuthorization\AdditionalAmounts\TotalHealthcare
 * @phpstan-import-type TransitShape from \Increase\PendingTransactions\PendingTransaction\Source\CardAuthorization\AdditionalAmounts\Transit
 * @phpstan-import-type UnknownShape from \Increase\PendingTransactions\PendingTransaction\Source\CardAuthorization\AdditionalAmounts\Unknown
 * @phpstan-import-type VisionShape from \Increase\PendingTransactions\PendingTransaction\Source\CardAuthorization\AdditionalAmounts\Vision
 *
