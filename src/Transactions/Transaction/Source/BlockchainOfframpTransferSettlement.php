 ...
 *
 * @phpstan-type BlockchainOfframpTransferSettlementShape = array{
 *   sourceBlockchainAddressID: string, transferID: string
 * }
 */
final class BlockchainOfframpTransferSettlement implements BaseModel
{
    /** @use SdkModel<BlockchainOfframpTransferSettlementShape> */
    use SdkModel;
    ...
    /**
     * `new BlockchainOfframpTransferSettlement()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * BlockchainOfframpTransferSettlement::with(
     ...
     *
     * ```
     * (new BlockchainOfframpTransferSettlement)
