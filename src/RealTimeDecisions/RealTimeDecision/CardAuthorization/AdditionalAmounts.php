...
use Increase\RealTimeDecisions\RealTimeDecision\CardAuthorization\AdditionalAmounts\Clinic;
use Increase\RealTimeDecisions\RealTimeDecision\CardAuthorization\AdditionalAmounts\Dental;
use Increase\RealTimeDecisions\RealTimeDecision\CardAuthorization\AdditionalAmounts\Original;
use Increase\RealTimeDecisions\RealTimeDecision\CardAuthorization\AdditionalAmounts\Prescription;
use Increase\RealTimeDecisions\RealTimeDecision\CardAuthorization\AdditionalAmounts\Surcharge;
use Increase\RealTimeDecisions\RealTimeDecision\CardAuthorization\AdditionalAmounts\TotalCumulative;
use Increase\RealTimeDecisions\RealTimeDecision\CardAuthorization\AdditionalAmounts\TotalHealthcare;
use Increase\RealTimeDecisions\RealTimeDecision\CardAuthorization\AdditionalAmounts\Transit;
use Increase\RealTimeDecisions\RealTimeDecision\CardAuthorization\AdditionalAmounts\Unknown;
use Increase\RealTimeDecisions\RealTimeDecision\CardAuthorization\AdditionalAmounts\Vision;
 ...
 *
 * @phpstan-import-type ClinicShape from \Increase\RealTimeDecisions\RealTimeDecision\CardAuthorization\AdditionalAmounts\Clinic
 * @phpstan-import-type DentalShape from \Increase\RealTimeDecisions\RealTimeDecision\CardAuthorization\AdditionalAmounts\Dental
 * @phpstan-import-type OriginalShape from \Increase\RealTimeDecisions\RealTimeDecision\CardAuthorization\AdditionalAmounts\Original
 * @phpstan-import-type PrescriptionShape from \Increase\RealTimeDecisions\RealTimeDecision\CardAuthorization\AdditionalAmounts\Prescription
 * @phpstan-import-type SurchargeShape from \Increase\RealTimeDecisions\RealTimeDecision\CardAuthorization\AdditionalAmounts\Surcharge
 * @phpstan-import-type TotalCumulativeShape from \Increase\RealTimeDecisions\RealTimeDecision\CardAuthorization\AdditionalAmounts\TotalCumulative
 * @phpstan-import-type TotalHealthcareShape from \Increase\RealTimeDecisions\RealTimeDecision\CardAuthorization\AdditionalAmounts\TotalHealthcare
 * @phpstan-import-type TransitShape from \Increase\RealTimeDecisions\RealTimeDecision\CardAuthorization\AdditionalAmounts\Transit
 * @phpstan-import-type UnknownShape from \Increase\RealTimeDecisions\RealTimeDecision\CardAuthorization\AdditionalAmounts\Unknown
 * @phpstan-import-type VisionShape from \Increase\RealTimeDecisions\RealTimeDecision\CardAuthorization\AdditionalAmounts\Vision
 *
