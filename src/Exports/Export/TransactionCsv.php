...
use Increase\Exports\Export\TransactionCsv\CreatedAt;

/**
 * Details of the transaction CSV export. This field will be present when the `category` is equal to `transaction_csv`.
 *
 * @phpstan-import-type CreatedAtShape from \Increase\Exports\Export\TransactionCsv\CreatedAt
 *
...
final class TransactionCsv implements BaseModel
{
    ...
    /**
     * `new TransactionCsv()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * TransactionCsv::with(accountID: ..., createdAt: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new TransactionCsv)->withAccountID(...)->withCreatedAt(...)
     * ```
     */
