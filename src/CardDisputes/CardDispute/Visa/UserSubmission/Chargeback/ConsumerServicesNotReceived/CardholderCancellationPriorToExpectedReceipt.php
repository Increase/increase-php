...
final class CardholderCancellationPriorToExpectedReceipt implements BaseModel
{
     ...
     * ```
     * CardholderCancellationPriorToExpectedReceipt::with(canceledAt: ..., reason: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new CardholderCancellationPriorToExpectedReceipt)
     *   ->withCanceledAt(...)
     *   ->withReason(...)
     * ```
     */
     ...
     */
    public static function with(string $canceledAt, ?string $reason): self
    {
        $self = new self;
