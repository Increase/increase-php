...
namespace Increase\Cards\Card\AuthorizationControls\Usage\SingleUse;

use Increase\Cards\Card\AuthorizationControls\Usage\SingleUse\SettlementAmount\Comparison;
