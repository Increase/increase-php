 ...
 * List Card Profiles.
 *
 * @see Increase\Services\DigitalCardProfilesService::list()
 *
 * @phpstan-import-type StatusShape from \Increase\DigitalCardProfiles\DigitalCardProfileListParams\Status
 *
 * @phpstan-type DigitalCardProfileListParamsShape = array{
 *   cursor?: string|null,
 ...
 * }
 */
final class DigitalCardProfileListParams implements BaseModel
{
    /** @use SdkModel<DigitalCardProfileListParamsShape> */
    use SdkModel;
    use SdkParams;
