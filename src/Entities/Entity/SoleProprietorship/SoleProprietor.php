...
namespace Increase\Entities\Entity\SoleProprietorship;

use Increase\Core\Attributes\Required;
use Increase\Core\Concerns\SdkModel;
use Increase\Core\Contracts\BaseModel;
use Increase\Entities\Entity\SoleProprietorship\SoleProprietor\Address;
use Increase\Entities\Entity\SoleProprietorship\SoleProprietor\Identification;

/**
 * The individual who operates the sole proprietorship.
 *
 * @phpstan-import-type AddressShape from \Increase\Entities\Entity\SoleProprietorship\SoleProprietor\Address
 * @phpstan-import-type IdentificationShape from \Increase\Entities\Entity\SoleProprietorship\SoleProprietor\Identification
 *
 * @phpstan-type SoleProprietorShape = array{
 *   address: \Increase\Entities\Entity\SoleProprietorship\SoleProprietor\Address|AddressShape,
 *   dateOfBirth: string,
