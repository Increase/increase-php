 ...
 * }
 */
final class ACHPrenotificationListParams implements BaseModel
{
    /** @use SdkModel<ACHPrenotificationListParamsShape> */
    use SdkModel;
    use SdkParams;
