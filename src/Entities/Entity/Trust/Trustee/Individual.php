...
use Increase\Entities\Entity\Trust\Trustee\Individual\Address;
use Increase\Entities\Entity\Trust\Trustee\Individual\Identification;

/**
 * The individual trustee of the trust. Will be present if the trustee's `structure` is equal to `individual`.
 *
 * @phpstan-import-type AddressShape from \Increase\Entities\Entity\Trust\Trustee\Individual\Address
 * @phpstan-import-type IdentificationShape from \Increase\Entities\Entity\Trust\Trustee\Individual\Identification
 *
