 ...
 *
 * @see Increase\Services\WireDrawdownRequestsService::list()
 *
 * @phpstan-import-type StatusShape from \Increase\WireDrawdownRequests\WireDrawdownRequestListParams\Status
 *
 * @phpstan-type WireDrawdownRequestListParamsShape = array{
 *   cursor?: string|null,
 ...
 * }
 */
final class WireDrawdownRequestListParams implements BaseModel
{
    /** @use SdkModel<WireDrawdownRequestListParamsShape> */
    use SdkModel;
    use SdkParams;
